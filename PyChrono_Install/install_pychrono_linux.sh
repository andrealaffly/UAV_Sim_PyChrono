...
# Marzan Alam
# Date: 7/19/25
# PyChrono Installer for Ubuntu 22.04

set -e
echo "==== PyChrono Installer for Ubuntu 22.04 ===="
...
if [ -x "$HOME/miniconda3/bin/conda" ]; then
    ...
    echo "Miniconda not found in $HOME/miniconda3 or /opt/miniconda3."
...
TARBALL="$HOME/Downloads/pychrono-8.0.0-py310_0.tar.bz2"
if [ ! -f "$TARBALL" ]; then
    ...
    echo "URL: https://anaconda.org/conda-forge/pychrono/files"
    exit 1
fi
...
echo "Add this to your ~/.bashrc: export PYTHONPATH=$PYTHONPATH"
