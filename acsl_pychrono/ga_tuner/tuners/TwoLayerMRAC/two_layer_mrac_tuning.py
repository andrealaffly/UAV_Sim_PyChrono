...
"""TwoLayerMRAC controller parameter tuning implementation using base class."""
...
class TwoLayerMRACTuning(BaseMRACTuning):
    """
    ...
    CONTROLLER_MODULE = "acsl_pychrono.control.TwoLayerMRAC"
    
    def __init__(self, tuning_config: Dict[str, Any] = None):
        """Initialize TwoLayerMRACGains tuning interface."""
        self.GAINS_CLASS = TwoLayerMRACGains
        super().__init__(tuning_config)
        
    def _extract_gains_from_object(self, gains_obj) -> Dict[str, Any]:
        """Extract TwoLayerMRAC-specific gains."""
        # Get base MRAC gains
